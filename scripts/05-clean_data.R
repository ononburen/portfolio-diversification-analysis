...
write_parquet(returns_2017, "data/04-analysis_data/annual_returns_2017.parquet")
write_parquet(returns_2020, "data/04-analysis_data/annual_returns_2020.parquet")
write_parquet(final_portfolio_2017, "data/04-analysis_data/final_portfolio_2017.parquet")
write_parquet(final_portfolio_2020, "data/04-analysis_data/final_portfolio_2020.parquet")