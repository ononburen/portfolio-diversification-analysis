...
# company basket. This basket was generated by "08-compant_basket", which
...
# Ensure you fetched the data properl
head(stock_prices)

# When we run this code, we can see that data on three company tickers 
...
# remove these three companies from our basket.
problematic_tickers <- c("SW", "GEV", "VLTO") # Make sure to inspect console for
